    ...
    if require_operational:
        ...
        checks.extend(
            [
                ...
                check(smoke.get("coordinate_click_attempts") == 0, "native smoke coordinate_click_attempts=0"),
                check(smoke.get("calculator_click_verified") is True, "native smoke Calculator click verified"),
                check(smoke.get("calculator_display_verified") is True, "native smoke Calculator display verified"),
